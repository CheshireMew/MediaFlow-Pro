...
def task_message_label(code: str) -> str:
    labels = {
        ...
        "preparing_asr_audio_probe": QCoreApplication.translate(
            "TaskMessageCatalog", "正在读取转录音频信息"
        ),
        ...
        "asr_silence_detection": QCoreApplication.translate(
            "TaskMessageCatalog", "正在检测长音频静音位置"
        ),
        "asr_chunk_extracting": QCoreApplication.translate(
            "TaskMessageCatalog", "正在生成长音频分块"
        ),
        "asr_chunks_transcribing": QCoreApplication.translate(
            "TaskMessageCatalog", "正在并行转录长音频分块"
        ),
        ...
        "proxy_sdr_encoding": QCoreApplication.translate(
            "TaskMessageCatalog", "正在创建 SDR 轻量预览文件"
        ),
        ...
        "export_quality_proof_frames": QCoreApplication.translate(
            "TaskMessageCatalog", "正在生成成片证明帧"
        ),
        "export_quality_hashing": QCoreApplication.translate(
            "TaskMessageCatalog", "正在校验成片文件"
        ),
        ...
        "web_render_cache_ready": QCoreApplication.translate(
            "TaskMessageCatalog", "正在复用已有网页画面"
        ),
        ...
        "download_analysis_saving": QCoreApplication.translate(
    ...
    return [
        {
            ...
            "description": QCoreApplication.translate(
                "TransitionCatalog", capability.description_key
            ),
